...
ppmtrans: ppmtrans.o cputiming.o transform.o uarray2b.o uarray2.o a2plain.o updatepicture.o rotate.o timerfile.o transpose.o flip.o getmethod.o
	$(CC) $(LDFLAaGS) $^ -o $@ $(LDLIBS)
